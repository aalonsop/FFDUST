...
REAL         :: XRADMIN = 0.1 ! minimum reasonable value for median radius AALONSOP 28/03
! 
...
!
!
! NEW spotting parametrization - AALONSOP 28/03
!Initial dry number median radius (um) 
REAL, DIMENSION(3)          :: XINIRADIUS= 0.5*(/50000.0, 5000.0, 1000.0 /)
!Initial, standard deviation from Alfaro et al 1998
REAL, DIMENSION(3)          :: XINISIG =  (/1.75, 1.76, 1.70/)
!Minimum allowed number concentration for any mode (#/m3)
!REAL, DIMENSION(3)          :: XN0MIN  = (/1.e-5 , 1.e-5 , 1.e-10 /)
REAL, DIMENSION(3)          :: XN0MIN  = (/1.e-20 , 1.e-20 , 1.e-20 /)
!
!
