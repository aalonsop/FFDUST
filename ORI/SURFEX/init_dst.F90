...
! 
ELSEIF (CEMISPARAM_DST.EQ."AAP") THEN ! Default: New firebrand distribution from AAP
  CRGUNIT   = 'NUMB'
  XEMISRADIUS_INI_DST(:) = 0.5*(/ 50000.0, 5000.0, 1000.0 /)  ! [um] Number median radius 
  XEMISSIG_INI_DST   (:) = (/  1.75, 1.76, 1.70 /)   ! [frc] Geometric standard deviation   
  XMSS_FRC_SRC_INI   (:) = (/0.0005, 0.0029, 0.9966/)    ! [frc] Mass fraction 
ENDIF
!
